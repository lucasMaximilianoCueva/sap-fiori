		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ListaFacturasfacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ListaFacturasfacturas-display": {
								"semanticObject": "ListaFacturasfacturas",
								"action": "display",
								"description": "btp.fiori",
								"title": "Lista Facturas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ListaFacturas.facturas",
									"url": sap.ui.require.toUrl("ListaFacturas/facturas")
								}
							}
						}
					}
